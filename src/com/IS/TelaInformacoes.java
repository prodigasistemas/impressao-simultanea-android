...
public class TelaInformacoes extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	List<String> infoList = ControladorImovel.getInstancia().getCadastroDataManipulator().selectInformacoesRota();
    	...
    	((TextView)findViewById(R.id.valorTotalImoveis)).setText(String.valueOf(ControladorImovel.getInstancia().getCadastroDataManipulator().getNumeroCadastros()));

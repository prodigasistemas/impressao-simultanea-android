...
public class TelaInformacoes extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	List<String> infoList = Controlador.getInstancia().getDataManipulator().selectInformacoesRota();
    	...
    	((TextView)findViewById(R.id.valorTotalImoveis)).setText(String.valueOf(Controlador.getInstancia().getDataManipulator().getNumeroCadastros()));

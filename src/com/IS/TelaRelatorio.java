...
public class TelaRelatorio extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	((TextView)findViewById(R.id.txtNumeroConcluidos)).setText(String.valueOf(listStatus.get(Constantes.IMOVEL_STATUS_CONCLUIDO)));
    	...
    	((TextView)findViewById(R.id.txtNumeroPendentes)).setText(String.valueOf(listStatus.get(Constantes.IMOVEL_STATUS_PENDENTE)));
		...
		((TextView)findViewById(R.id.txtNumeroImpressos)).setText(String.valueOf(listStatus.get(Constantes.IMOVEL_IMPRESSO)));
    	...
    	((TextView)findViewById(R.id.txtNumeroRetidos)).setText(String.valueOf(listStatus.get(Constantes.IMOVEL_RETIDO)));
    	...
    	((TextView)findViewById(R.id.txtNumeroHidrometradosConcluidos)).setText(String.valueOf(listStatus.get(Constantes.IMOVEL_HIDROMETRADO_CONCLUIDO)));
    	...
    	((TextView)findViewById(R.id.txtNumeroFixosConcluidos)).setText(String.valueOf(listStatus.get(Constantes.IMOVEL_NAO_MEDIDO_CONCLUIDO)));
